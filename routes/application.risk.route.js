...
router.get('/column-name',async function (req,res) {
    try {
        ...
        const debtorColumn = req.user.manageColumns.find(i => i.moduleName === 'application');
        let columnList = [];
...
router.put('/column-name',async function (req,res) {
    ...
    try {
        ...
        await User.updateOne({_id:req.user._id,'manageColumns.moduleName':'application'},{$set:{'manageColumns.$.columns':updateColumns}});
