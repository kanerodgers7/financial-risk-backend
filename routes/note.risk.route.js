        ...
        if(req.query.noteFor === 'application'){
            ...
            query = {
                $and: [{
                    ...
                    $or: [{createdByType: 'client-user', createdById: application.clientId},
            ...
            query = {
                $and: [{
                    ...
                    $or: [{createdByType: 'client-user', createdById: debtor.clientId},
                        {createdByType: 'user', isPublic: true},
                        {createdByType: 'user', createdById: req.user._id}]
                }]
            }
            ...
            query = {
                $and: [{
                    ...
                    $or: [{createdByType: 'user', isPublic: true},
                        {createdByType: 'user', createdById: req.user._id}]
                }]
            }
        }
