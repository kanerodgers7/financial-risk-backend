...
router.get('/column-name',async function (req,res) {
    try {
        ...
        const debtorColumn = req.user.manageColumns.find(i => i.moduleName === 'task');
        let columnList = [];
...
router.put('/column-name',async function (req,res) {
    ...
    try {
        ...
        await User.updateOne({_id:req.user._id,'manageColumns.moduleName':'task'},{$set:{'manageColumns.$.columns':updateColumns}});
